package com.mad.StayCoza.UtilityClasses;
...
public class Utility
{
    ...
    public static void PrepareAlbums() {
        ...
        Product a = new Product(0,"Samrat Hotel", 2750.0, "3.5", covers[0]);
        productsList.add(a);

        a = new Product(1,"The Surya Hotel", 3500.0, "2.5", covers[1]);
        productsList.add(a);

        a = new Product(2,"Hillton Green Hotel", 3700.0, "3.0", covers[2]);
        productsList.add(a);

        a = new Product(3,"Holiday Inn Hotel", 5200.0, "4.5", covers[3]);
        productsList.add(a);

        a = new Product(4,"Radisson Blu", 6500.0, "5", covers[4]);
        productsList.add(a);

        a = new Product(5,"Hotel Gault", 5400.0, "3", covers[5]);
        productsList.add(a);

        a = new Product(6,"Le Square Phillips Hotel", 7750.0, "4", covers[6]);
        productsList.add(a);

        a = new Product(7,"Le ST Martin Hotel", 3800.0, "4.5", covers[7]);
        productsList.add(a);

        a = new Product(8,"Hotel Taj", 9600.0, "5", covers[8]);
        productsList.add(a);

        a = new Product(9,"Hotel Lalit", 2700.0, "4", covers[9]);
        productsList.add(a);
    }
